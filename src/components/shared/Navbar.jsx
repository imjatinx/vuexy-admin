                ...
                <div className="navbar-container d-flex content">
                    <div className="bookmark-wrapper d-flex align-items-center">
                        ...
                        <ul className="nav navbar-nav bookmark-icons">
                            ...
                            <li className="nav-item d-none d-lg-block"><a className="nav-link" href="app-calendar.html" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Calendar"><i className="ficon" data-feather="calendar"></i></a></li>
                            <li className="nav-item d-none d-lg-block"><a className="nav-link" href="app-todo.html" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Todo"><i className="ficon" data-feather="check-square"></i></a></li>
                        </ul>
                        <ul className="nav navbar-nav">
                            <li className="nav-item d-none d-lg-block"><a className="nav-link bookmark-star"><i className="ficon text-warning" data-feather="star"></i></a>
                                <div className="bookmark-input search-input">
                                    <div className="bookmark-input-icon"><i data-feather="search"></i></div>
                    ...
                    <ul className="nav navbar-nav align-items-center ms-auto">
                        ...
                        <li className="nav-item nav-search"><a className="nav-link nav-link-search"><i className="ficon" data-feather="search"></i></a>
                        ...
                        <li className="nav-item dropdown dropdown-cart me-25"><a className="nav-link" href="#" data-bs-toggle="dropdown"><i className="ficon" data-feather="shopping-cart"></i><span className="badge rounded-pill bg-primary badge-up cart-item-count">6</span></a>
                            <ul className="dropdown-menu dropdown-menu-media dropdown-menu-end">
                                ...
                                <li className="scrollable-container media-list">
                                    <div className="list-item align-items-center"><img className="d-block rounded me-1" src="/src/assets/app-assets/images/pages/eCommerce/1.png" alt="donuts" width="62" />
                                        <div className="list-item-body flex-grow-1"><i className="ficon cart-item-remove" data-feather="x"></i>
                                    ...
                                    <div className="list-item align-items-center"><img className="d-block rounded me-1" src="/src/assets/app-assets/images/pages/eCommerce/7.png" alt="donuts" width="62" />
                                        <div className="list-item-body flex-grow-1"><i className="ficon cart-item-remove" data-feather="x"></i>
                                            <div className="media-heading">
                                    ...
                                    <div className="list-item align-items-center"><img className="d-block rounded me-1" src="/src/assets/app-assets/images/pages/eCommerce/2.png" alt="donuts" width="62" />
                                        <div className="list-item-body flex-grow-1"><i className="ficon cart-item-remove" data-feather="x"></i>
                                            <div className="media-heading">
                                    ...
                                    <div className="list-item align-items-center"><img className="d-block rounded me-1" src="/src/assets/app-assets/images/pages/eCommerce/3.png" alt="donuts" width="62" />
                                        <div className="list-item-body flex-grow-1"><i className="ficon cart-item-remove" data-feather="x"></i>
                                            <div className="media-heading">
                                    ...
                                    <div className="list-item align-items-center"><img className="d-block rounded me-1" src="/src/assets/app-assets/images/pages/eCommerce/5.png" alt="donuts" width="62" />
                                        <div className="list-item-body flex-grow-1"><i className="ficon cart-item-remove" data-feather="x"></i>
                                            <div className="media-heading">
                            ...
                            <ul className="dropdown-menu dropdown-menu-media dropdown-menu-end">
                                ...
                                <li className="scrollable-container media-list"><a className="d-flex" href="#">
                                    <div className="list-item d-flex align-items-start">
                                        <div className="me-1">
                                            <div className="avatar"><img src="/src/assets/app-assets/images/portrait/small/avatar-s-15.jpg" alt="avatar" width="32" height="32" /></div>
                                        </div>
                                        ...
                                        <div className="list-item d-flex align-items-start">
                                            <div className="me-1">
                                                <div className="avatar"><img src="/src/assets/app-assets/images/portrait/small/avatar-s-3.jpg" alt="avatar" width="32" height="32" /></div>
                                            </div>
                                            <div className="list-item-body flex-grow-1">
            ...
            <ul className="main-search-list-defaultlist d-none">
                ...
                <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                    <div className="d-flex">
                        <div className="me-75"><img src="/src/assets/app-assets/images/icons/xls.png" alt="png" height="32" /></div>
                ...
                <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                    <div className="d-flex">
                        <div className="me-75"><img src="/src/assets/app-assets/images/icons/jpg.png" alt="png" height="32" /></div>
                        <div className="search-data">
                ...
                <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                    <div className="d-flex">
                        <div className="me-75"><img src="/src/assets/app-assets/images/icons/pdf.png" alt="png" height="32" /></div>
                        <div className="search-data">
                ...
                <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                    <div className="d-flex">
                        <div className="me-75"><img src="/src/assets/app-assets/images/icons/doc.png" alt="png" height="32" /></div>
                        <div className="search-data">
                ...
                <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                    <div className="d-flex align-items-center">
                        <div className="avatar me-75"><img src="/src/assets/app-assets/images/portrait/small/avatar-s-8.jpg" alt="png" height="32" /></div>
                        <div className="search-data">
                ...
                <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                    <div className="d-flex align-items-center">
                        <div className="avatar me-75"><img src="/src/assets/app-assets/images/portrait/small/avatar-s-1.jpg" alt="png" height="32" /></div>
                        <div className="search-data">
                ...
                <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                    <div className="d-flex align-items-center">
                        <div className="avatar me-75"><img src="/src/assets/app-assets/images/portrait/small/avatar-s-14.jpg" alt="png" height="32" /></div>
                        <div className="search-data">
                ...
                <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                    <div className="d-flex align-items-center">
                        <div className="avatar me-75"><img src="/src/assets/app-assets/images/portrait/small/avatar-s-6.jpg" alt="png" height="32" /></div>
                        <div className="search-data">
